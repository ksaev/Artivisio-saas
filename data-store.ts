...
export const entretiens: Entretien[] = [
  {
    id: "ent_1",
    candidatureId: "1", // ID de la candidature côté candidat
    candidatId: "cand_3",
    recruteurId: "rec_3",
    offreId: "offre_3",
    date: "2024-01-25",
  ...
  {
    id: "ent_2",
    candidatureId: "3", // ID de la candidature côté candidat
    candidatId: "cand_3",
    recruteurId: "rec_3",
    offreId: "offre_3",
    date: "2024-01-22",
...
export const getCandidatsByOffre = (offreId: string): Candidat[] => {
  return candidats.filter((candidat) => candidat.offreId === offreId)
}
