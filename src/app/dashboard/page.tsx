      ...
      <section className="bg-gradient-to-br from-primary/5 to-accent/10 py-12">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-foreground mb-2">Bonjour {user?.firstName || "Membre"} ! 👋</h1>
              <p className="text-muted-foreground">Continuons à construire votre carrière d'exception</p>
            </div>
            <PulsingElement>
